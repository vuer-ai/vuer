...
<iframe src="https://vuer.ai/?collapseMenu=True&fov=50&grid=False&reconnect=0&scene={scene}" width="100%" height="400" frameborder="0"></iframe>

Or click on this <a href="https://vuer.ai/?collapseMenu=True&grid=False&fov=50&reconnect=0&scene={scene}">link</a> to visit the scene in full screen.
...
Or click on this <a href="https://vuer.ai/?collapseMenu=True&fov=50&grid=False&reconnect=0&scene={scene}">link</a> to visit the scene in full screen.
