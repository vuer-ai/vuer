...
This example demonstrates how to apply textures to a trimesh using UV mapping in Vuer.
You'll learn how to load a 3D mesh, generate UV coordinates from vertex positions,
and apply an image texture with optional repeat parameters.
