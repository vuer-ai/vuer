...
def show_heatmap():
    page = Page(
        Scene(
            ...
            Gripper(movable=True, pinchWidth=1, skeleton=False, axes=True, position=[0, .2, 0], key="gripper", ),
    ...
    while event != "TERMINAL":
        ...
        event = yield Frame(Update(
            Gripper(movable=True, pinchWidth=1, skeleton=False, axes=True, position=position, key="gripper", ),
            style={"width": "100vw", "height": "900px"},
        ))
        sleep(0.0166)
